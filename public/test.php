...
<script src="libraries/jquery.wechat.share.js"></script>
<script>
    $(function(){
...
<!--//wx.config({-->
<!--//    debug: true,-->
<!--//    appId: 'wx399cbb3183a80aba', // 必填，公众号的唯一标识-->
<!--//    timestamp: 1426916659 , // 必填，生成签名的时间戳-->
<!--//    nonceStr: 'TRU79jfuieui23ewewe', // 必填，生成签名的随机串-->
<!--//    signature: 'ec0f473dd918e00c706e3c752a782b495905a036',// 必填，签名，见附录1-->
<!--//    jsApiList: [-->
<!--//        'checkJsApi',-->
<!--//        'onMenuShareTimeline',-->
<!--//        'onMenuShareAppMessage',-->
