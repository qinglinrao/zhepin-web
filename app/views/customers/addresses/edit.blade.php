	...
	<div id="main-wrapper">
		<div id="header" class="clearfix">
			...
			<div class="center">
				...
				<h1 id="page-title">修改地址</h1>
			</div>
		</div>
		<div id="main-content">
		    {{Form::open(array('url'=>URL::route('address.update'),'id'=>'new_address','class'=>'new-address-form'))}}
			    <p class="form-tip">{{$errors->first()}}</p>
				<div class="new-address-wrapper">
					<div class="block">
						<div class="field-wrapper">
						    {{Form::text('name',$address->name,array('id'=>'address_consignee','class'=>'consignee-field','placeholder'=>'收件人姓名'))}}
						</div>
						<div class="field-wrapper">
						    {{Form::text('telephone',$address->telephone,array('id'=>'address_phone','class'=>'phone-field','placeholder'=>'电话号码'))}}
						</div>
						<div class="field-wrapper">
						    {{Form::location('region',$region,1)}}
						</div>
						<div class="field-wrapper">
							{{Form::text('address',$address->address,array('id'=>'address_address','class'=>'address-field','placeholder'=>'详细地址'))}}
						</div>
					</div>
					<div class="field-wrapper">
