...
@section('wrapper')
	<div id="main-wrapper">
		...
		<div id="header" class="clearfix">
			...
			<div class="center">
				<h1 id="page-title">用户登录</h1>
			</div>
		</div>
		<div id="main-content">
			<div class="user-login has-padding">
			    {{Form::open(array('url'=>URL::route('customers.login'),'id'=>'customer-login','class'=>'new_customer'))}}
					...
					{{--<input type="hidden" value="1" name="site_id" id="customer_site_id" />--}}
					{{--<div class="field-wrapper clearfix">--}}
						{{--<a href="#" class="forget-password"><span>忘记密码?</span></a>--}}
					{{--</div>--}}
					<div class="field-wrapper">
					...
					<div class="field-wrapper">
						<div class="register-link">
							<a href="{{URL::route('customers.register')}}">还没有账号？立即注册</a>
							<a href="#"><span></span></a>
						</div>
					</div>
				{{Form::close()}}
